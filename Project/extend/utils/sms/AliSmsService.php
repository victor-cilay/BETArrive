...
class AliSmsService
{
	...
	public static function sendSms($data,$config){
		...
		$params["SignName"] = $config['ali_sms_signname'];
		$params["TemplateCode"] = $config['ali_sms_tempcode'];
...
//		}
		...
		$content = self::request($config['ali_sms_accesskeyid'],$config['ali_sms_accesskeysecret'],"dysmsapi.aliyuncs.com",
