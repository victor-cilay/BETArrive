(global.webpackJsonp = global.webpackJsonp || []).push([ [ "gc_school/pages/article/index" ], {
    "003e": function(t, e, a) {
        var n = a("bb76");
        a.n(n).a;
    },
        ...
        (function(t) {
            ...
            var r = getApp(), c = {
                ...
                onPullDownRefresh: function() {
                    this.dataList = [], this.page = 1, this.pullDown.start(), this.getCate(), this.getSlide(), 
                ...
                methods: {
                    ...
                    getLst: function(e) {
                        ...
                        r.globalData.util.request({
                            ...
                            success: function(t) {
                                a.pullDown.end(), console.log(t.data.data.list), t.data.data.list.length < 5 && a.setData({
                                    is_loadmore: !1
                                }), a.dataList = 1 == a.page ? t.data.data.list : [].concat(s(a.dataList), s(t.data.data.list));
                            }
                        });
                    },
...
}, [ [ "fdf8", "common/runtime", "common/vendor" ] ] ]);